...
// (admin, kasir, vendor, user)
// =============================================
Route::middleware('auth')->group(function () {

    // Halaman umum - semua role bisa akses
    ...
    // =============================================
    // VENDOR - hanya vendor master & restock
    // =============================================
    Route::middleware('role:admin,vendor')->group(function () {
        ...
        // Vendor master (vendor bisa lihat datanya sendiri)
        Route::get('/vendor', [VendorController::class, 'index'])->name('vendor.index');
    });

    // =============================================
    // KASIR - halaman product & kasir
    // =============================================
    ...
    // =============================================
    // USER - semua halaman KECUALI vendor master, restock, product
    // =============================================
    Route::middleware('role:admin,user')->group(function () {
        // Tidak ada route khusus tambahan untuk user saat ini
        // user hanya bisa akses /home dan halaman umum di atas
    });

});

// Route vendor restock (akses publik untuk vendor eksternal - opsional)
